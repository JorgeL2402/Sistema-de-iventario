<?php
    ...
    if($check_user->rowCount()==1){
    	...
    	if($check_user['usuario_usuario']==$usuario && password_verify($clave, $check_user['usuario_clave'])){
    		...
    		if(headers_sent()){
				// Redireccionar usando JavaScript si se han enviado encabezados
				echo "<script> window.location.href='index.php?vista=home'; </script>";
			}else{
				// Redireccionar usando encabezados de redirección si no se han enviado encabezados
				header("Location: index.php?vista=home");
			}

    	}else{
    		// Mostrar mensaje de usuario o clave incorrectos
    		echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
